-- ** Creer la table analitique pour la combinaison des deux chifres dans n'importe quel order **
...
SET @n1 = 0 
 ...
 SELECT (SUM (fois)) FROM Q2_anal
  WHERE (n1=0 and n2=1) or (n1=1 and n2=0)

SELECT (MIN(jp)) FROM Q2_anal
  WHERE (n1=0 and n2=1) or (n1=1 and n2=0)

SELECT (MIN (minim)) FROM Q2_anal
  WHERE (n1=0 and n2=1) or (n1=1 and n2=0)

SELECT (MAX (maxim)) FROM Q2_anal
  WHERE (n1=0 and n2=1) or (n1=1 and n2=0)
